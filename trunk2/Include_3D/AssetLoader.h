...
#include <osg/Node>
#include <osg/ValueObject>  // 必须包含，用于设置加载后的 UserValue
#include <osg/ref_ptr>
...
class AssetLoader : public QObject {
 ...
 public:
  ...
  osg::ref_ptr<osg::Object> load(const QString& filePath, AssetRecord* asset);
  ...
  osg::ref_ptr<osg::Object> loadObj(const QString& filePath,
                                    AssetRecord* asset);
  osg::ref_ptr<osg::Object> loadLine(const QString& filePath,
                                     AssetRecord* asset);
